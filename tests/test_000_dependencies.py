...
from hiss.ddbc_bindings import normalize_architecture
...
class DependencyTester:
    ...
    def _get_module_directory(self):
        """Get the hiss module directory."""
        try:
            import hiss
            module_file = hiss.__file__
            return Path(module_file).parent
        except ImportError:
            # Fallback to relative path from tests directory
            return Path(__file__).parent.parent / "hiss"
...
class TestPlatformDetection:
    ...
    def test_module_directory_exists(self):
        """Test that the hiss module directory exists."""
...
class TestDependencyFiles:
    ...
    def test_python_extension_loadable(self):
        ...
        try:
            import hiss.ddbc_bindings
            # Test that we can access a basic function
            assert hasattr(hiss.ddbc_bindings, 'normalize_architecture')
...
def test_get_driver_path_from_ddbc_bindings():
    ...
    try:
        import hiss.ddbc_bindings as ddbc
