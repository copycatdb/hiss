"""
This file contains tests for the global variables in the hiss package.
Functions:
...
from hiss import apilevel, threadsafety, paramstyle, lowercase, getDecimalSeparator, setDecimalSeparator
...
def test_lowercase_thread_safety_no_db():
    """
    Tests concurrent modifications to hiss.lowercase without database interaction.
    ...
    assert hiss.lowercase is False, "Final state of lowercase should be False"
