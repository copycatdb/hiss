...
import pytest
import glob
from hiss.logging_config import setup_logging, get_logger, LoggingManager
...
def get_log_file_path():
    ...
    log_dir = os.path.join(repo_root_dir, "hiss", "logs")
...
def test_setup_logging(cleanup_logger):
    ...
    try:
        ...
        assert logger == logging.getLogger('hiss')
...
def test_timestamp_in_log_filename(cleanup_logger):
    ...
    try:
        ...
        # Fix: Account for the fact that "hiss" contains an underscore
