...
import threading
from hiss.cursor import Cursor
from hiss.helpers import add_driver_to_connection_str, sanitize_connection_string, sanitize_user_input, log
from hiss import ddbc_bindings
from hiss.pooling import PoolingManager
from hiss.exceptions import InterfaceError, ProgrammingError
from hiss.auth import process_connection_string
...
from hiss.constants import GetInfoConstants
...
class Connection:
    ...
    def setencoding(self, encoding=None, ctype=None):
        ...
        Example:
            ...
            cnxn.setencoding(encoding='utf-8', ctype=hiss.SQL_CHAR)
        """
        if self._closed:
    ...
    def setdecoding(self, sqltype, encoding=None, ctype=None):
        ...
        Example:
            ...
            cnxn.setdecoding(hiss.SQL_CHAR, encoding='utf-8')
            
            # Configure column metadata decoding
            cnxn.setdecoding(hiss.SQL_WMETADATA, encoding='utf-16le')
            
            # Use explicit ctype
            cnxn.setdecoding(hiss.SQL_WCHAR, encoding='utf-16le', ctype=hiss.SQL_WCHAR)
        """
        if self._closed:
            raise InterfaceError(
                driver_error="Connection is closed",
    ...
    def getdecoding(self, sqltype):
        ...
        Example:
            settings = cnxn.getdecoding(hiss.SQL_CHAR)
